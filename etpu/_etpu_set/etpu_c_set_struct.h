...
typedef struct
{
	...
	/* 0x003c */
	etpu_if_uint32 : 32;
} etpu_if_C_I2C_slave_CHANNEL_FRAME;
#define etpu_if_C_I2C_slave_CHANNEL_FRAME_EXPECTED_SIZE 64
...
} etpu_if_C_I2C_slave_CHANNEL_FRAME_PSE;
#define etpu_if_C_I2C_slave_CHANNEL_FRAME_PSE_EXPECTED_SIZE 64
...
typedef struct
{
	...
	/* 0x003c */
	etpu_if_uint32				_byte_cnt;
} etpu_if_C_I2C_slave_CHANNEL_FRAME_unsignedPSE;
#define etpu_if_C_I2C_slave_CHANNEL_FRAME_unsignedPSE_EXPECTED_SIZE 64
...
typedef struct
{
	...
	/* 0x003c */
	etpu_if_uint32 : 32;
} etpu_if_C_I2C_master_CHANNEL_FRAME;
#define etpu_if_C_I2C_master_CHANNEL_FRAME_EXPECTED_SIZE 64
...
} etpu_if_C_I2C_master_CHANNEL_FRAME_PSE;
#define etpu_if_C_I2C_master_CHANNEL_FRAME_PSE_EXPECTED_SIZE 64
...
typedef struct
{
	...
	/* 0x003c */
	etpu_if_uint32				_p_cmd_list;
} etpu_if_C_I2C_master_CHANNEL_FRAME_unsignedPSE;
#define etpu_if_C_I2C_master_CHANNEL_FRAME_unsignedPSE_EXPECTED_SIZE 64
