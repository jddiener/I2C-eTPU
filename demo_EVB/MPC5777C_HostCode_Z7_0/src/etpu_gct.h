...
#define ETPU_ENGINE_C_CHANNEL(x)  (x)
...
*******************************************************************************/
#define ETPU_I2C_MASTER_BASE_CHAN	ETPU_ENGINE_A_CHANNEL(0)
#define ETPU_I2C_SLAVE1_BASE_CHAN	ETPU_ENGINE_B_CHANNEL(0)
#define ETPU_I2C_SLAVE2_BASE_CHAN	ETPU_ENGINE_C_CHANNEL(4)
