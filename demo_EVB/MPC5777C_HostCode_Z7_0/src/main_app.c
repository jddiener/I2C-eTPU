...
int user_main()
{
	...
	while (1)
	{
	    ...
	    if (aw_etpu_i2c_master_init(&i2c_master_instance, &i2c_master_config))
	    	return 1;
	    if (aw_etpu_i2c_slave_init(&i2c_slave1_instance, &i2c_slave1_config))
	    	return 1;
	    if (aw_etpu_i2c_slave_init(&i2c_slave2_instance, &i2c_slave2_config))
	    	return 1;
		...
		/* long pause before repeating test */
		wait_time(1000);
	}
